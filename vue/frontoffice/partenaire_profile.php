...
<body align="center">
    ...
    <div class="profile-container">
        ...
        <p><strong>Entreprise:</strong> <?php echo htmlspecialchars($user['entreprise']); ?></p>
        <p><strong>Secteur:</strong> <?php echo htmlspecialchars($user['secteur']); ?></p>
        <p><strong>Site_web:</strong> <?php echo htmlspecialchars($user['site_web']); ?></p>
        ...
        <form action="update_profile_partenaire.php" method="POST">
