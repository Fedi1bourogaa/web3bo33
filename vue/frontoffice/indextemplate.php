...
include 'C:\xampp\htdocs\web3bo33\controller\EventE.php';
require_once 'C:\xampp\htdocs\web3bo33\controller\SponsorS.php';
...
$produits = $produitsController->listProduit(); // Valeur par défaut
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['reset'])) {
        ...
        $produits = $produitsController->listProduit();
    } elseif (isset($_POST['productCategory']) && !empty($_POST['productCategory'])) {
        // Sélectionner les produits par catégorie
        $categorie = $_POST['productCategory'];
        $produits = $Cc->selectProductsByCategory($categorie);
    } else {
        // Message d'erreur si aucune catégorie valide n'est fournie
    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="http://localhost/web3bo33/vue/amine/reservation.php">Reservation</a></li>
    ...
    <div class="col-lg-12">
          ...
          <label for="productCategory">Catégorie:</label>
                          <select id="productCategory" name="productCategory" class="form-control">
                              ...
                              <?php foreach ($tabC as $category) { ?>
                                  <option value="<?= $category['categorie_id']; ?>"><?= $category['nom']; ?>
                              </option>
                              <?php } ?>
                          </select>
                  <button type="submit" class="btn btn-primary mt-3">Filtrer</button>
                  <button type="submit" name="reset" class="btn btn-secondary mt-3">Réinitialiser</button>
              </form>
          ...
          <div class="swiper-wrapper">
            <?php foreach ($produits as $produit): ?>
                <a href="addPanier.php?id=<?php echo $produit['produit_id']; ?>" 
                  class="swiper-slide event-item d-flex flex-column justify-content-end" 
                  style="background-image: url('data:image/png;base64,<?= base64_encode($produit['image']); ?>');" 
                  aria-label="<?php echo $produit['nom']; ?>">
                    <h3><?php echo htmlspecialchars($produit['nom']); ?></h3>
                    <div class="price align-self-start"><?php echo htmlspecialchars($produit['prix']); ?>DT</div>
                </a>
            <?php endforeach; ?>
        </div>
    <div class="swiper-pagination"></div>
...
<div class="container" data-aos="fade-up" data-aos-delay="100">
  ...
  <footer id="footer" class="footer dark-background">
   ...
   <!-- Chatbot Icon -->
   <div id="chatbot-icon">
        <img src="tunisia-flag.jpg" alt="Assistant El Hadhra">
    </div>

    <!-- Chatbot Box -->
    <div id="chatbot-box">
        <div id="chatbot-header">
            <span>Assistant El Hadhra</span>
            <button onclick="toggleChatbot()">×</button>
        </div>
        <div id="chatbot-messages">
            <p>Bienvenue à El Hadhra . Posez vos questions !</p>
        </div>
         <div id="chatbot-input-container">
            <input type="text" id="chatbot-input" placeholder="Écrivez votre question...">
