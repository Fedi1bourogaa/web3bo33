                ...
                <div class="card">
                    ...
                    <form method="POST" id ="ajoutForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="productPrice" name="productPrice" step="0.01" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label for="productPrice">Stock:</label>
                                <input type="number" id="productStock" name="productStock" step="0.01" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label for="productDate">Date d'ajout:</label>
                                <input type="date" id="productDate" name="productDate" class="form-control" >
                            </div>
                            <div class="form-group">
