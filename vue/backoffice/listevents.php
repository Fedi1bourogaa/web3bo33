...
<body>
        ...
        <a href="stat.php" class="btn-statistics">Voir Statistiques</a>
        <style>
        .btn-statistics {
        ...
        .btn-statistics:hover {
            ...
            <div class="table-responsive">
                <table class="table" style="font-size: 0.85rem;">
                    ...
                    <tbody>
                        <?php
                        // Boucle pour afficher chaque événement dans le tableau
                        foreach ($listt as $event) {
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img src="<?= htmlspecialchars($event['image']); ?>" style="max-width: 100px; max-height: 100px;">
                                </td>
                                <td>
                                    <!-- Lien vers la page de modification de l'événement -->
                                    <a href="updateevent.php?id=<?= $event['id_event']; ?>" class="btn btn-warning">Modifier</a>
                                </td>
                                <td>
                                    <!-- Lien de suppression avec confirmation -->
                                    <a href="deleteevent.php?id_event=<?= htmlspecialchars($event['id_event']); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet événement ?');">Supprimer</a>
                                </td>
                            </tr>
                        <?php
                        }
