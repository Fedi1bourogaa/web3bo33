...
// Récupération des utilisateurs ayant le rôle "partenaire"
$sql = "SELECT id, nom, prenom, email, role FROM users WHERE role = 'partenaire'";
...
<head>
    ...
    <title>Tableau des Partenaires</title>
    ...
    <main>
        ...
        <div class="content">
            ...
            <?php if (isset($_GET['message']) && $_GET['message'] === 'deleted'): ?>
                <p class="success">Partenaire supprimé avec succès.</p>
            <?php endif; ?>
                ...
                <tbody>
                    <?php foreach ($partenaires as $partenaire): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($partenaire['prenom']); ?></td>
                            <td><?php echo htmlspecialchars($partenaire['email']); ?></td>
                            <td><?php echo htmlspecialchars($partenaire['role']); ?></td>
                            <td>
                                <!-- Formulaire pour supprimer un partenaire -->
                                <form action="dashboard.php" method="get" style="display: inline;">
                                    <input type="hidden" name="delete" value="<?php echo htmlspecialchars($partenaire['email']); ?>">
