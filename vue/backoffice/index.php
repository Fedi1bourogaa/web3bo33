<?php
  require_once 'C:\xampp\htdocs\web3bo33\controller\ProduitsController.php';
  require_once 'C:\xampp\htdocs\web3bo33\controller\CategoriesController.php';
  require_once 'C:\xampp\htdocs\web3bo33\controller\CommandeController.php';
  ...
  <body>
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="addevent.php">
                  <i class="fas fa-pen-square"></i>
                  <a href="listevents.php" class="btn btn-link">
    Events <span class="caret"></span>
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="addevent.php">
                  <i class="fas fa-pen-square"></i>
                  <a href="listsponsor.php" class="btn btn-link">
    sponsors <span class="caret"></span>
              ...
              <li class="nav-item">
                <a href="http://localhost/web3bo33/vue/amine/room.php">
                  <i class="fas fa-desktop"></i>
                  <p>reservation</p>
                  <span class="badge badge-success">4</span>
                </a>
